...
export const VEHICLE_ROWS: Row[] = [
  ...
  ["BYD", "Qin Plus EV", "47.5 kWh", 2021, null, 47.5, 47.5, 420, 11.3, 6.6, 70, "GBT_DC", 1630, "FWD"],
  ["BYD", "Qin Plus EV", "57.6 kWh", 2021, null, 57.6, 57.6, 420, 13.7, 7, 89, "GBT_DC", 1740, "FWD"],
  ["BYD", "Seagull", "30.08 kWh", 2023, null, 30.08, 30.08, 305, 9.9, 6.6, 30, "GBT_DC", 1160, "FWD"],
  ["BYD", "Seagull", "38.88 kWh", 2023, null, 38.88, 37, 405, 9.6, 6.6, 40, "GBT_DC", 1240, "FWD"],
  ["BYD", "e2", "43.2 kWh", 2019, null, 43.2, 43.2, 401, 10.8, 6.6, 40, "GBT_DC", 1250, "FWD"],
  ...
  // ── BMW ──────────────────────────────────────────────────────────
  ["BMW", "i3", "60Ah 22.6 kWh", 2013, 2016, 22.6, 18.8, 190, 12.9, 7.4, 50, "CCS2", 1195, "RWD"],
  ["BMW", "i3", "94Ah 33.2 kWh", 2016, 2018, 33.2, 27.2, 300, 13.1, 11, 50, "CCS2", 1245, "RWD"],
  ["BMW", "i3", "120Ah 42.2 kWh", 2018, 2022, 42.2, 37.9, 308, 16.3, 11, 50, "CCS2", 1345, "RWD"],
  ...
  ["Audi", "e-tron", "50 quattro 71 kWh", 2019, 2022, 71, 64.7, 341, 21.8, 11, 120, "CCS2", 2445, "AWD"],
  ["Audi", "e-tron", "55 quattro 95 kWh", 2019, 2022, 95, 86.5, 441, 22.5, 11, 150, "CCS2", 2490, "AWD"],
  ...
  // ── Hyundai ──────────────────────────────────────────────────────
  ["Hyundai", "Ioniq Electric", "28 kWh", 2016, 2019, 28, 28, 200, 11.5, 6.6, 70, "CCS2", 1420, "FWD"],
  ["Hyundai", "Ioniq Electric", "38.3 kWh", 2019, 2022, 38.3, 38.3, 311, 13.8, 7.2, 44, "CCS2", 1527, "FWD"],
  ...
  ["Hyundai", "Kona Electric", "39.2 kWh (Gen1)", 2018, 2023, 39.2, 39.2, 305, 14.3, 7.2, 44, "CCS2", 1610, "FWD"],
  ["Hyundai", "Kona Electric", "64 kWh (Gen1)", 2018, 2023, 64, 64, 484, 14.7, 7.2, 77, "CCS2", 1685, "FWD"],
  ["Hyundai", "Kona Electric", "48.4 kWh", 2023, null, 48.4, 48.4, 377, 14.7, 11, 74, "CCS2", 1690, "FWD"],
  ...
  ["Kia", "e-Niro", "39.2 kWh (Gen1)", 2019, 2022, 39.2, 39.2, 289, 14.9, 7.2, 44, "CCS2", 1667, "FWD"],
  ["Kia", "e-Niro", "64 kWh (Gen1)", 2019, 2022, 64, 64, 455, 15.9, 7.2, 77, "CCS2", 1737, "FWD"],
  ["Kia", "Soul EV", "27 kWh", 2015, 2017, 27, 27, 212, 14.7, 6.6, 70, "CHADEMO", 1565, "FWD"],
  ["Kia", "Soul EV", "30 kWh", 2018, 2019, 30, 30, 250, 14.3, 6.6, 70, "CHADEMO", 1580, "FWD"],
  ["Kia", "Soul EV", "39.2 kWh", 2020, null, 39.2, 39.2, 276, 15.7, 7.2, 77, "CCS2", 1610, "FWD"],
  ["Kia", "Soul EV", "64 kWh", 2020, null, 64, 64, 452, 15.7, 7.2, 77, "CCS2", 1682, "FWD"],

  // ── Volkswagen ───────────────────────────────────────────────────
  ["Volkswagen", "e-Golf", "24.2 kWh", 2014, 2016, 24.2, 21.2, 190, 12.7, 3.6, 40, "CCS2", 1520, "FWD"],
  ["Volkswagen", "e-Golf", "35.8 kWh", 2017, 2020, 35.8, 32, 231, 13.8, 7.2, 40, "CCS2", 1615, "FWD"],
  ...
  // ── Nissan ───────────────────────────────────────────────────────
  ["Nissan", "Leaf", "24 kWh", 2011, 2016, 24, 22, 199, 15, 3.6, 46, "CHADEMO", 1475, "FWD"],
  ["Nissan", "Leaf", "30 kWh", 2016, 2017, 30, 28, 250, 15, 6.6, 46, "CHADEMO", 1516, "FWD"],
  ...
  ["Neta", "V", "38.5 kWh", 2020, null, 38.5, 36.6, 401, 13.5, 6.6, 48, "GBT_DC", 1130, "FWD"],
  ["Neta", "Aya", "40.7 kWh", 2023, null, 40.7, 38.7, 401, 13.5, 6.6, 48, "GBT_DC", 1150, "FWD"],
  ["Neta", "U Pro 400", "54.3 kWh", 2021, null, 54.3, 51.5, 400, 16.0, 6.6, 60, "GBT_DC", 1600, "FWD"],
  ["Neta", "U Pro 500", "70.4 kWh", 2021, null, 70.4, 67, 500, 16.5, 6.6, 80, "GBT_DC", 1650, "FWD"],
  ["Neta", "X", "52 kWh", 2024, null, 52, 49.5, 401, 15.5, 6.6, 80, "GBT_DC", 1560, "FWD"],
  ["Neta", "X", "62 kWh", 2024, null, 62, 59, 501, 15.8, 11, 80, "GBT_DC", 1610, "FWD"],
  ["Neta", "GT", "78.4 kWh", 2023, null, 78.4, 74.5, 580, 16.0, 11, 120, "GBT_DC", 1810, "RWD"],
  ...
  // ── Dongfeng (Nammi 01 = Box, same model) ────────────────────────
  ["Dongfeng", "Box", "31.45 kWh", 2023, null, 31.45, 30, 330, 12.6, 6.6, 55, "GBT_DC", 1180, "RWD"],
  ["Dongfeng", "Box", "42.3 kWh", 2023, null, 42.3, 40.9, 430, 13.2, 6.6, 71, "GBT_DC", 1245, "RWD"],
  ...
  ["Renault", "Zoe", "ZE40 R110 41 kWh", 2017, 2019, 41, 41, 300, 16.3, 22, 0, "TYPE2", 1480, "FWD"],
  ...
  // ── Chevrolet (very common US used-import in Jordan) ─────────────
  ["Chevrolet", "Bolt EV", "60 kWh", 2017, 2019, 60, 60, 383, 15.7, 7.2, 55, "CCS2", 1616, "FWD"],
  ["Chevrolet", "Bolt EV", "66 kWh", 2020, 2023, 66, 65, 417, 15.8, 7.2, 55, "CCS2", 1628, "FWD"],
  ["Chevrolet", "Bolt EUV", "65 kWh", 2022, 2023, 65, 65, 397, 16.4, 7.2, 55, "CCS2", 1669, "FWD"],

  // ── Toyota ───────────────────────────────────────────────────────
  ["Toyota", "C-HR EV", "54.3 kWh", 2020, null, 54.3, 54.3, 400, 13.1, 6.6, 60, "GBT_DC", 1780, "FWD"],
  ["Toyota", "bZ4X", "71.4 kWh FWD", 2022, null, 71.4, 64, 516, 14.3, 6.6, 150, "CCS2", 1920, "FWD"],

  // ── Jaguar ───────────────────────────────────────────────────────
  ["Jaguar", "I-Pace", "EV400 90 kWh", 2018, 2024, 90, 84.7, 470, 22, 7.4, 100, "CCS2", 2208, "AWD"],

  // ── Mini ─────────────────────────────────────────────────────────
  ["Mini", "Cooper SE", "32.6 kWh", 2020, 2023, 32.6, 28.9, 234, 15.2, 11, 50, "CCS2", 1365, "FWD"],
